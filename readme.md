...
1. `2A > 5C > 2C > 236B > 6C > 6B > 214A~D/214B+D > 2C > 236A~B~A~C > 236A+D`
...
1. `66B` **Midscreen ([^footnote]_for full combos, midscreen usually means combo must start midscreen and not end in the corner_)**
...
1. `6D, j2C, 2A > 5C > 2C > 236A > 9D, dljC, 66C > j236A > j6C > j214B~D, 66B > 236B~A~B > 236A+D`

   _2864 dmg_ **|** **Midscreen**

   - Confirming with `2A` instead of `5A` adds over 100 damage.

2. `6D, j2C, 2A > 5C > 2C > 236B~A > dl9D, jB > jC, 66C > j236A > j6C > j214B~D, 66B > 236A~B~A~C > 236A+D`

   _2934 dmg_ **|** **Midscreen**

   - Slight damage gain by adding `236B` and `jB`, but you need to delay the `236A` jump cancel.

3. `6D, j2C, 2A > 5C > 236A > 9D, dljC, 66B > 236B > 421A~D, 66C > j236A > j6B > j214A, 66C`
...
1. `2A/5A > 5C/2C > 236A > 9D, icj2C, 2C/5C > 236B > 6C > dl6B > 214A/214B+D, 66B > 236B~A~B > 236A+D`
...
2. `2A/5A > 5C/2C > 236A > 9D, icj2C, 66C > j236A > j6C > j214A~D, 66B > 236B~A~B > 236A+D`

   _3077 dmg_ **|** **Midscreen**

   - The pre-SC BNB. Still offers decent corner carry. Also possible as `dlj236A > j6C > j214B~D`.

3. `2A > 5C > 236A > 9D, icj2C, tk236A~B~D, 2C > 236B > (6C > dl) 214B, 66B > 236A~B~A~C > 236A+D`
...
1. `5B > 5C/2C > 236A > 9D, icj2C, 66C(1) > j236A > j6B > dlj6C > j214A > 8, jC > jB 66B > 236B~A~B > 236A+D`
...
2. `5C > 236A~D, 66C(1) > j236B > j6C > j6A > dlj214B, 5B/5C > dlj2C > jB > jC, 66B > 236B~A~B > 236A+D`
...
1. `2C > 5C > 236A > w6B/w6C~D, 9jC > j6B/j6C > j421C > 236A > dl9D, j2C > jB, 66C > j236A > j6C > j214B~D, 66B > 236B~A~B > 236A+D`
...
2. `antiair 5C > jC > j6B/j6C > j421C > 236A > 8D, icj2C, 2C > 236B > 6C > dl6B > 214A/214B+D, 66B > 236A~B~A~C > 236A+D`
...
3. `antiair 5C > (dl)236A > w6B/w6C~D, 9jC > j6B/j6C > j421C > 236A > 8D, icj2C, 2C > 236B > 6C > dl6B > 214A/214B+D, 66B > 236A~B~A~C > 236A+D`
...
4. `2C > 5C > j2C > jB > jC, 66B > 236B > 421A~D > 66C > j236A > j6B > j214A, 66B > 236A > 214B > 421A~D`

   _3440 dmg_ **|** **Corner**

   - Simple corner `2C 5C` confirm

5. `2C > 5C > 236A > w6C~D, jC > j6B > dlj236B > 8D, icj2C, 66B > 236B > 6C > 214A, 66B > 236A > 214B > 421A~D`
...
5. `66C > j236A~B > j214B+D, 5C (> 2C) > 236A > w6C~D, jB > j2C > jC, 66B > 236B~A~B > 236A+D`
...
1. `236B~D, 236A/236B > dl214B~D, 2C > 5C > dlj2C > jB > jC, 66B > 236B~A~B > 236A+D`
...
2. `236B~D, 236A > 421C > dl j214B~D, 2C > 5C > dlj2C > jB > jC, 66B > 236A~B~A~B > 236A+D`
...
3. `236B~D, 236A > 421C > (j421B >) j6A > j214A+D, 2C > 5C > dlj2C > jB > jC, 66B > 236A~B~A~B > 236A+D`
...
4. `236B~D, dl236A > 421B > dl6A > 214B+D, 2C > 5C > dlj2C > jB > jC, 66B > 236A~B~A~B > 236A+D`
...
6. `j236A/j6C > j236B > j214B+D, 2C > 5C > dlj2C > jB > jC, 66B > 236A~B~A~C > 236A+D`
...
7. `236B~D, 66C(1) > j236A > 9D, icj2C, 5C > 236A > 6C > dl6B > 214A/214B+D, 66B > 236A > 214B > 421A~D`
...
9. `236B~D, 236C > 421B > dl236A > w6C~D, j2C > jB > jC, 66C > j236A > j6C > j214B~D, 66B > 236A~B~A~C > 236AD`
...
10. `236B, 421B > 6A > FF~A~D, 2C > 236A > dl9D, jB > jC, 66C > j236A > j6B > j214A, 66B > 236A > 214B > 421A~D`
...
1. `236C > 421B > 2FF > 2C > 236A > 9D > j2[C] > 66C(1) > j236A > j6B > dl j6C > j214A > 8, jC > jB, 66B > 236B~A~B > 236AD`
...
2. `236C > 421B > dl6C > dl236A > 9D, icj2C, 66C(1) > j236A > j6B > j6C > dlj214A > 8, j.C > j.B, 66B > 236B~A~B > 236A+D`
...
3. `236C > 421B > 236A~D, 66C(1) > j236A > 9D, icj2C, 5C (> dl2C) > 236B > 6C > dl6B > 214A/214B+D, 66B > 236A~B~A~C > 236A+D`
...
5. `236C > 421C > j236A > 8D, icj2C, 2C > 236B > 6C > dl6B > 214A/214B+D, 66B > 236A~B~A~C > 236A+D`
   ...
   _4029 dmg_ **|** 100 EXS **|** **Midscreen, Far**
...
6. `236C > 421B > 236A > 9D, icj2C, tk j236A > j6B > j6C > j6A > 9D, j.B > j.C 66B > 236B > 6C > dl6B > 214A, 66B > 236A > 214B > 421A`
...
1. `214X~D/j214X~D, 2A > 5C > j2C > jB > jC, 66B > 236A > dl 9D, j.B > j.C, 66B > 236B~A~B > 236AD`
...
2. `j214X(~D, 66B) > 236A > 9D, icj2C, 2C > 5C > j2C > jB > jC, 66B > 236B~A~B > 236AD`
...
3. `j214X(~D, 66B) > 236A > 9D, icj2C, 5C > j2C > jB > jC, 66B > 236B > 6C > 214B > 421A`
...
1. `jB > j6C > j236B > dl j214A, 2C > 5C > j2C > jB > jC, 66B > 236A~B~A~C > 236AD`
...
2. `jB > j6C > j421C > 2FF, 2C > 236A > 9D > j2[C], 5C > 236B > 6C > dl 6B > 214A, 66B > 236A~B~A~C > 236AD`
...
`214B...ABAC AD~` _3462_ sideswaps  
 `214B...BAB AD~` _3448_ sideswaps  
 `214A...ABAC AD~` ~_3440_ doesn't  
 `214A...BAB AD~` ~_3440_ doesn't
