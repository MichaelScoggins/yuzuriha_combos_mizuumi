...
1. `66B` **Midscreen (_for full combos, midscreen usually means combo must start midscreen and not end in the corner_)**
...
2. `236B~D, 236A > 421C > dl j214B~D, 2C > 5C > dlj2C > jB > jC, 66B > 236A~B~A~B > 236A+D` _3184 dmg_ **|** **Midscreen**

   - Higher damage conversion with less carry. Delay `j214B` slightly to get more hits and higher damage.
   - _Kiri ender: 3365 damage_

3. `236B~D, 236A > 421C > (j421B >) j6A > j214A+D, 2C > 5C > dlj2C > jB > jC, 66B > 236A~B~A~B > 236A+D` _3345 dmg_ **|** **Midscreen**
...
10. `236B, 421B > 6A > FF~A~D, 2C > 236A > dl9D, jB > jC, 66C > j236A > j6B > j214A, 66B > 236A > 214B > 421A~D` _3296 dmg_ **|** 1 GRD\_ **|** **Back to Corner**
...
1. `236C > 421B > 2FF > 2C > 236A > 9D > j2[C] > 66C(1) > j236A > j6B > dl j6C > j214A > 8, jC > jB, 66B > 236B~A~B > 236AD` _4134 dmg_ **|** 100 EXS, 1 GRD **|** **Midscreen**

   - Universal `236C` confirm for varying ranges. Sideswaps from about 2/3rds screen and closer.

2. `236C > 421B > dl6C > dl236A > 9D, icj2C, 66C(1) > j236A > j6B > j6C > dlj214A > 8, j.C > j.B, 66B > 236B~A~B > 236A+D` _4176 dmg_ **|** 100 EXS **|** **Midscreen**

   - GRDless Midscreen confirm for varying ranges. Sideswaps from about 2/3rds screen and closer.
   - _Kiri ender: 4241 damage_

3. `236C > 421B > 236A~D, 66C(1) > j236A > 9D, icj2C, 5C (> dl2C) > 236B > 6C > dl6B > 214A/214B+D, 66B > 236A~B~A~C > 236A+D` _4064/4156 dmg_ **|** 100 EXS **|** **Midscreen, Close**
...
4. `236C > 6B > dl236A > 9D, icj2C, 66C(1) > j236A > j6B > j6C > dlj214A > 8, j.C > j.B, 66B > 236B~A~B > 236A+D` _4379 dmg_ **|** 100 EXS **|** **Midscreen, Close**

   - Same side `236C` punish route for forward carry

5. `236C > 421C > j236A > 8D, icj2C, 2C > 236B > 6C > dl6B > 214A/214B+D, 66B > 236A~B~A~C > 236A+D` _4029 dmg_ **|** 100 EXS **|** **Midscreen, Far**
...
6. `236C > 421B > 236A > 9D, icj2C, tk j236A > j6B > j6C > j6A > 9D, j.B > j.C 66B > 236B > 6C > dl6B > 214A, 66B > 236A > 214B > 421A` _4539 dmg_ **|** 100 EXS **|** **Corner, Close**
...
1. `214X~D/j214X~D, 2A > 5C > j2C > jB > jC, 66B > 236A > dl 9D, j.B > j.C, 66B > 236B~A~B > 236AD` _3219 dmg_ **|** **Anywhere**
...
2. `j214X(~D, 66B) > 236A > 9D, icj2C, 2C > 5C > j2C > jB > jC, 66B > 236B~A~B > 236AD` _3275 dmg_ **|** **Midscreen**

   - Better confirm for `TK j214X~D`. If you remain in stance and confirm with `(6X > dl) 236A` this also works from grounded `214X`.

3. `j214X(~D, 66B) > 236A > 9D, icj2C, 5C > j2C > jB > jC, 66B > 236B > 6C > 214B > 421A` _3447 dmg_ **|** **Corner**
...
1. `jB > j6C > j236B > dl j214A, 2C > 5C > j2C > jB > jC, 66B > 236A~B~A~C > 236AD` _3045 dmg_ **|** **Midscreen**

   - Standard air to air `jB` hit combo. If you can get in range to avoid distance proration, the combo does _3167_

2. `jB > j6C > j421C > 2FF, 2C > 236A > 9D > j2[C], 5C > 236B > 6C > dl 6B > 214A, 66B > 236A~B~A~C > 236AD` _3238 dmg_ **|** 1 GRD **|** **Midscreen**
