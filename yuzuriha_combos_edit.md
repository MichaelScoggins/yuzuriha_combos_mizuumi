...
1. `66B > 236B~A~B > 236A+D > 236C/214C/IW` _100/200 EXS_ **Midscreen**
...
1. `A+D~2, 2B > A+B` _1533_ **Anywhere**
...
4. `A+D~2, 66C(1) > j236B > 7/8D, icj2C, 2C > 236B > 6C > dl6B > 214A, 66B > 236A > 214B > 421A~D` _1972_ **Corner**
...
5. `2AA > A+D~2, 5C > 236B > 6C > (dl6B >) 214A > 66B > 236A~B~A~C > 236A+D` _1447_ **Anywhere**
...
1. `6D, j2C, 2A > 5C > 2C > 236A > 9D, dljC, 66C > j236A > j6C > j214B~D, 66B > 236B~A~B > 236A+D` _2864_ **Midscreen**

   - Confirming with `2A` instead of `5A` adds over 100 damage.

2. `6D, j2C, 2A > 5C > 2C > 236B~A > dl9D, jB > jC, 66C > j236A > j6C > j214B~D, 66B > 236A~B~A~C > 236A+D` _2934_ **Midscreen**

   - Slight damage gain by adding `236B` and `jB`, but you need to delay the `236A` jump cancel.

3. `6D, j2C, 2A > 5C > 236A > 9D, dljC, 66B > 236B > 421A~D, 66C > j236A > j6B > j214A, 66C` _2740_ **Corner**
   - Adding `jB` after `236A` does slightly more damage but requires a delayed jump after `236A`.

## A starters

1. `2A/5A > 5C/2C > 236A > 9D, icj2C, 2C/5C > 236B > 6C > dl6B > 214A/214B+D, 66B > 236B~A~B > 236A+D` _3246_ **Anywhere**
...
3. `2A > 5C > 236A > 9D, icj2C, tk236A~B~D, 2C > 236B > (6C > dl) 214B, 66B > 236A~B~A~C > 236A+D` _3219 (3326)_ **Corner**
...
1. `2C > 5C > 236A > w6B/w6C~D, 9jC > j6B/j6C > j421C > 236A > dl9D, j2C > jB, 66C > j236A > j6C > j214B~D, 66B > 236B~A~B > 236A+D` _3557_ **Midscreen**
...
2. `antiair 5C > jC > j6B/j6C > j421C > 236A > 8D, icj2C, 2C > 236B > 6C > dl6B > 214A/214B+D, 66B > 236A~B~A~C > 236A+D` _3388_ **Midscreen**
...
3. `antiair 5C > (dl)236A > w6B/w6C~D, 9jC > j6B/j6C > j421C > 236A > 8D, icj2C, 2C > 236B > 6C > dl6B > 214A/214B+D, 66B > 236A~B~A~C > 236A+D` _3444_ **Midscreen**
...
4. `2C > 5C > j2C > jB > jC, 66B > 236B > 421A~D > 66C > j236A > j6B > j214A, 66B > 236A > 214B > 421A~D` _3440_ **Corner**

   - Simple corner `2C 5C` confirm

5. `2C > 5C > 236A > w6C~D, jC > j6B > dlj236B > 8D, icj2C, 66B > 236B > 6C > 214A, 66B > 236A > 214B > 421A~D` _3514_ **Corner**
   - Stronger corner `2C 5C` confirm

## Force Function Starter/Extension

1. `2A/5A > 5C > 236A > 9D, icj2C, 2C/6C > 6A > FF~A~D, 66C > j236A > j6C > j214A~D, 66B > 236B~A~B > 236A+D` _3394 1 GRD_ **Midscreen**

   - `FF~A` extension for damage and carry at the expense of some GRD

2. `5B > 5C > 236A > 9D, icj2C, 2C > 236B > 6A > FF~A~D > dl 9, j.B > j.C > 66C > j236A > j6C > j214A~D, 66B > 236A~B~A~C > 236A+D` _3654 1 GRD 101 Opp: 59_ **Midscreen**
...
3. `236A, (66B > 236B >) 6A > FF~A~D, 2C > 5C > j2C > jB > jC, 66C > j236A > j6C > j214B~D, 66B > 236B~A~B > 236A+D` _3751 (3673) 1 GRD_ **Midscreen**
...
4. `2FF, 2C > 236A > 9D, j2[C], 66C(1) > j236A > j6B > dlj6C > j214A > 8, jC > jB, 66B > 236B~A~B > 236AD` _3440 1 GRD 81 Opp: 45_ **Midscreen**
...
1. `66C(1) > j214X, 5C > 2C > 236A > w6C~D, jB > j2C > jC, 66B > 236B~A~B > 236A+D` _3052_ **Anywhere**

   - Reliable confirm when `66C(1)` hits on attempted `66C(1) > j214X` resets in pressure

2. `66C(1) > j236A > 9D, icj2C, 2C > 236B > 6C > dl6B > 214A/214B+D, 66B > 236A~B~A~C > 236A+D` _3390_ **Anywhere**

   - Same concepts as the `236A 66C(1)` `j236A` punish route, adapted for `66C(1) starter`.

3. `66C(1) > j236B > j6C > j6A > dlj214B, 2C > 5C > dlj2C > jB > jC, 66B > 236A~B~A~C > 236A+D` _3328_ **Anywhere**

   - Adaptation of the carry punish route for `66C(1)` starter. This is also your optimal confirm from `counterhit tk j236A` (_3794_).

4. `66C(1) > j236B > j421C > 2FF, 2C > 236A > 9D, j.2[C], 5C > 236B > 6C > dl 6B > 214A > 66B > 236A~B~A~C > 236AD` _3462_ **Midscreen**

   - Utilizes `2FF` to pick up after `j.236B`, gives both high damage and excellent corner carry

5. `66C > j236A~B > j214B+D, 5C (> 2C) > 236A > w6C~D, jB > j2C > jC, 66B > 236B~A~B > 236A+D` _3274_ **Midscreen**
...
1. `236B~D, 236A/236B > dl214B~D, 2C > 5C > dlj2C > jB > jC, 66B > 236B~A~B > 236A+D` _3009/2716_ **Midscreen**
...
5. `236B~D, 236B > 421C > j236B > j214B+D, 2C > 5C > dlj2C > jB > jC, 66B > 236B~A~B > 236A+D` _2781_
   `236B~D, 236B > 421B > dl236A > dl214B~D, 2C > 5C > dlj2C > jB > jC, 66B > 236B~A~B > 236A+D` _2739_ **Midscreen**
...
8. `236B~D, 236C > 421A > 236B > 214B+D, 2C > 5C > dlj2C > jB > jC, 66B > 236A~B~A~C > 236AD` _3392_
   `236B~D, 236C > 421A > 236B~D, 236A > 421C > j214B~D, 5C > dlj2C > jB > jC, 66B > 236B~A~B > 236AD` _3341 100 EXS_ **Back to Corner**
...
9. `236B~D, 236C > 421B > dl236A > w6C~D, j2C > jB > jC, 66C > j236A > j6C > j214B~D, 66B > 236A~B~A~C > 236AD` _3470 100 EXS_ **Back to Corner**
...
3. `j214X(~D, 66B) > 236A > 9D, icj2C, 5C > j2C > jB > jC, 66B > 236B > 6C > 214B > 421A` _3447_ **Corner**
